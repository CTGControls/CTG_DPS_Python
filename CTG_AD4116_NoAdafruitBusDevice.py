...
class CTG_AD4116_NoAdafruitBusDevice:


    def startup(spiClk: int, CTG_AD4116ClassNoAdafruitBusDevice: CTG_AD4116ClassNoAdafruitBusDevice):
        # check if the id matches 0x34DX, where X is don't care 
        CTG_AD4116ClassNoAdafruitBusDevice.is_valid_id(spiClk)
        ...
        #/* SETUP0 - SETUP7 */
        #/* AIN0 - AIN16 */
        CTG_AD4116ClassNoAdafruitBusDevice.set_channel_config(spiClk, adc7173_register_t.CH0, True, adc7173_register_t.SETUP0, analog_input_t.AIN0, analog_input_t.AIN1)
        ...
        CTG_AD4116ClassNoAdafruitBusDevice.set_setup_config(spiClk, adc7173_register_t.SETUP0, coding_mode_t.BIPOLAR, ain_buf_mode_t.AIN_BUF_ENABLE, setup_ref_source_t.REF_EXT)

        #/* set ADC OFFSET0 offset value */
        #/* OFFSET0 - OFFSET7 */
        CTG_AD4116ClassNoAdafruitBusDevice.set_offset_config(spiClk, adc7173_register_t.OFFSET0, 0x55) 
        ...
        CTG_AD4116ClassNoAdafruitBusDevice.set_register(spiClk, adc7173_register_t.FILTER0, value, 2)

        #/* verify the updated configuration value */
        CTG_AD4116ClassNoAdafruitBusDevice.get_register(spiClk, adc7173_register_t.FILTER0, value, 2)
        ...
        CTG_AD4116ClassNoAdafruitBusDevice.set_adc_mode_config( spiClk, data_mode_t.CONTINUOUS_CONVERSION_MODE, clock_mode_t.INTERNAL_CLOCK, ref_mode_t.REF_DISABLE);
        ...
        CTG_AD4116ClassNoAdafruitBusDevice.set_interface_mode_config(spiClk, False, False);
